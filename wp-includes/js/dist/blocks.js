    ...
    /******/ var __webpack_modules__ = {
        /***/ 1030: /***/ function (module, exports, __webpack_require__) {
            ...
            (function () {
                 ...
                 */
                showdown.helper.regexIndexOf = function (
                    str,
                    regex,
                    fromIndex,
                ) {
                ...
                showdown.helper.emojis = {
                    ...
                    showdown:
                        "<span style=\"font-family: 'Anonymous Pro', monospace;  text-decoration-style: dashed; text-decoration-color: #3e8b8a;text-underline-position: under;\">S</span>",
                };
                        ...
                        function substitutePreCodeTags(doc) {
                            ...
                            for (var i = 0; i < pres.length; ++i) {
                                if (
                                    ...
                                    var content =
                                            pres[i].firstChild.innerHTML.trim(),
                                        language =
                ...
                showdown.subParser(
                    ...
                    function (text, options, globals) {
                        ...
                        text = showdown.subParser("tables")(
                            text,
                            options,
                            globals,
                        );
                ...
                showdown.subParser(
                    ...
                    function (text, options, globals) {
                        ...
                        if (
                            typeof globals.metadata.parsed.doctype !==
                            "undefined"
                        ) {
                            doctypeParsed =
                                "<!DOCTYPE " +
                        ...
                        for (var i = 0; i < blockTags.length; ++i) {
                            ...
                            while (
                                ...
                                var subTexts = showdown.helper.splitAtIndex(
                                    ...
                                    //3. Match recursively
                                    newSubText1 =
                                        showdown.helper.replaceRecursiveRegExp(
                                            subTexts[1],
                                            repFunc,
                                            patLeft,
                                            patRight,
                ...
                showdown.subParser(
                    ...
                    function (text, options, globals) {
                        ...
                        function headerId(m) {
                            ...
                            if (
                                showdown.helper.isString(options.prefixHeaderId)
                            ) {
    ...
    */
                    ...
                    function processListItems(listStr, trimTrailing) {
                        ...
                        listStr = listStr.replace(
                            ...
                            function (
                                ...
                                // Has sublist
                                if (m1 || item.search(/\n{2,}/) > -1) {
                                    item = showdown.subParser(
                                        "githubCodeBlocks",
                                    )(item, options, globals);
                ...
                showdown.subParser(
                    ...
                    function (text, options, globals) {
                        ...
                        text = showdown.subParser("images")(
                            text,
                            options,
                            globals,
                        );
                ...
                showdown.subParser(
                    ...
                    function (node, globals) {
                        ...
                        for (var i = 0; i < childrenLenght; ++i) {
                            listItemTxt += showdown.subParser(
                                "makeMarkdown.node",
                            )(children[i], globals);
                        }
...
***************************************************************************** */
        ...
        const i18n_block_namespaceObject = /*#__PURE__*/ JSON.parse(
            '{"title":"block title","description":"block description","keywords":["block keyword"],"styles":[{"label":"block style label"}],"variations":[{"title":"block variation title","description":"block variation description","keywords":["block variation keyword"]}]}',
        ...
        function registerBlockType(blockNameOrMetadata, settings) {
            ...
            const { addBootstrappedBlockType, addUnprocessedBlockType } =
        ...
        function bootstrappedBlockTypes(state = {}, action) {
            switch (action.type) {
                case "ADD_BOOTSTRAPPED_BLOCK_TYPE":
                    ...
                    if (serverDefinition) {
                        if (
                            serverDefinition.blockHooks === void 0 &&
                        ...
                        if (
                            serverDefinition.allowedBlocks === void 0 &&
        ...
        function getActiveBlockVariation(state, blockName, attributes, scope) {
                ...
                if (Array.isArray(variation.isActive)) {
                    ...
                    const isMatch = definedAttributes.every((attribute) => {
                        ...
                        if (
                            ...
                            blockAttributeValue =
                                blockAttributeValue.toHTMLString();
                        }
            ...
            if (!match && ["block", "transform"].includes(scope)) {
                match = variations.find(
                    (variation) =>
                        variation?.isDefault &&
                        !Object.hasOwn(variation, "isActive"),
                );
            }
            return match;
        }
        ...
        function getNormalizedSearchTerm(term) {
            return remove_accents_default()(term ?? "")
                .toLowerCase()
                .trim();
        }
        ...
        const processBlockType =
            ...
            ({ select }) => {
                ...
                if (settings.apiVersion <= 2) {
                    external_wp_deprecated_default()(
                        "Block with API version 2 or lower",
                        {
                            since: "6.9",
                ...
                if (LEGACY_CATEGORY_MAPPING.hasOwnProperty(settings.category)) {
                    settings.category =
                        LEGACY_CATEGORY_MAPPING[settings.category];
                }
                if (
        ...
        function maybeCheckTransformIsMatch(transform, blocks) {
            ...
            const attributes = transform.isMultiBlock
                ? blocks.map((block2) => block2.attributes)
        ...
        const external_wp_autop_namespaceObject = window["wp"]["autop"]; // external "ReactJSXRuntime"
        const external_ReactJSXRuntime_namespaceObject =
            window["ReactJSXRuntime"]; // external ["wp","isShallowEqual"]
...
<!-- /wp:${blockName} -->`
        ...
        var shortcode_converter_default = segmentHTMLToShortcodeBlock; // ./node_modules/@wordpress/blocks/build-module/api/raw-handling/utils.js
...
${p3}`,
        ...
        const privateApis = {};
        lock(privateApis, { isContentBlock: isContentBlock }); // ./node_modules/@wordpress/blocks/build-module/deprecated.js
