/******/ (() => {
    ...
    const external_wp_richText_namespaceObject = window["wp"]["richText"]; // external "ReactJSXRuntime"
    const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // external ["wp","i18n"]
    ...
    const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // ./node_modules/@wordpress/icons/build-module/library/format-bold.js
    var format_bold_default = /* @__PURE__ */ (0,
        ...
        edit({ value, onChange, onFocus, isActive }) {
            function onClick() {
                onChange(
                    (0, external_wp_richText_namespaceObject.toggleFormat)(
                        value,
                        { type: code_name, title: code_title },
                    ),
                );
                onFocus();
            }
    ...
    const image_title = (0, external_wp_i18n_namespaceObject.__)(
        "Inline image",
    );
    ...
    function InlineUI({ value, onChange, activeObjectAttributes, contentRef }) {
        ...
        external_wp_richText_namespaceObject.useAnchor)({
                    ...
                    external_ReactJSXRuntime_namespaceObject.jsx)(
                        external_wp_blockEditor_namespaceObject.MediaUpload,
                        {
                            ...
                            onSelect: ({ id, url, alt, width: imgWidth }) => {
                                onChange(
                                    (0,
                                    external_wp_richText_namespaceObject.insertObject)(
                                        value,
                                        {
                                            type: image_name,
                                            attributes: {
    ...
    var format_italic_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
        ...
        edit({ isActive, value, onChange, onFocus }) {
            function onToggle() {
                onChange(
                    (0, external_wp_richText_namespaceObject.toggleFormat)(
                        value,
                        { type: italic_name, title: italic_title },
                    ),
                );
            }
            function onClick() {
    ...
    const external_wp_htmlEntities_namespaceObject =
        window["wp"]["htmlEntities"]; // ./node_modules/@wordpress/icons/build-module/library/link.js
    var link_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
    ...
    function isValidHref(href) {
        ...
        if (/^\S+:/.test(trimmedHref)) {
            ...
            if (
                !(0, external_wp_url_namespaceObject.isValidAuthority)(
                    authority,
                )
            ) {
                return false;
            }
            const path = (0, external_wp_url_namespaceObject.getPath)(
                trimmedHref,
            );
            if (
                path &&
                !(0, external_wp_url_namespaceObject.isValidPath)(path)
            ) {
                return false;
            }
            const queryString = (0,
            external_wp_url_namespaceObject.getQueryString)(trimmedHref);
            if (
                queryString &&
                !(0, external_wp_url_namespaceObject.isValidQueryString)(
                    queryString,
                )
            ) {
                return false;
    ...
    const walkToEnd = partialRight(walkToBoundary, "forwards"); // external ["wp","compose"]

    const external_wp_compose_namespaceObject = window["wp"]["compose"]; // ./node_modules/@wordpress/format-library/build-module/link/css-classes-setting.js
    const CSSClassesSettingComponent = ({ setting, value, onChange }) => {
        const hasValue = value ? value?.cssClasses?.length > 0 : false;
        const [isSettingActive, setIsSettingActive] = (0,
        external_wp_element_namespaceObject.useState)(hasValue);
        const instanceId = (0,
        ...
        return /* @__PURE__ */ (0,
        external_ReactJSXRuntime_namespaceObject.jsxs)("fieldset", {
            children: [
                /* @__PURE__ */ (0,
                external_ReactJSXRuntime_namespaceObject.jsx)(
                    external_wp_components_namespaceObject.VisuallyHidden,
                    { as: "legend", children: setting.title },
                ),
                /* @__PURE__ */ (0,
                external_ReactJSXRuntime_namespaceObject.jsxs)(
                    external_wp_components_namespaceObject.__experimentalVStack,
    ...
    var css_classes_setting_default = CSSClassesSettingComponent; // ./node_modules/@wordpress/format-library/build-module/link/inline.js
    ...
    function InlineLinkUI({
        ...
        const richLinkTextValue = getRichTextValueFromSelection(
            value,
            isActive,
        );
        ...
        function removeLink() {
            const newValue = (0,
            external_wp_richText_namespaceObject.removeFormat)(
                value,
                "core/link",
            );
            onChange(newValue);
        ...
        function onChangeLink(nextValue) {
            ...
            const linkFormat = createLinkFormat({
                ...
                type: nextValue.type,
                id:
                    nextValue.id !== void 0 && nextValue.id !== null
                        ? String(nextValue.id)
                        : void 0,
            ...
            if (
                ...
                const inserted = (0,
                external_wp_richText_namespaceObject.insert)(value, newText);
                newValue = (0,
                external_wp_richText_namespaceObject.applyFormat)(
                    inserted,
                    linkFormat,
                    value.start,
                ...
                const newValAfter = (0,
                external_wp_richText_namespaceObject.replace)(
                    valAfter,
                    richTextText,
                    newValue,
                );
        ...
        function createButtonText(searchTerm) {
            ...
            external_wp_element_namespaceObject.createInterpolateElement)(
                ...
                {
                    mark: /* @__PURE__ */ (0,
                    external_ReactJSXRuntime_namespaceObject.jsx)("mark", {}),
                },
            );
        }
        return /* @__PURE__ */ (0,
    ...
    var inline_default = InlineLinkUI; // ./node_modules/@wordpress/format-library/build-module/link/index.js
    ...
    function link_Edit({
        ...
        (0, external_wp_element_namespaceObject.useLayoutEffect)(() => {
            ...
            function handleClick(event) {
                ...
                if (
                    !link2 || // other formats (e.g. bold) may be nested within the link.
                    !isActive
                ) {
                    return;
                }
        ...
        function addLink(target) {
            const text = (0,
            external_wp_richText_namespaceObject.getTextContent)(
        ...
        const hasSelection = !(0,
        external_wp_richText_namespaceObject.isCollapsed)(value);
        return /* @__PURE__ */ (0,
        external_ReactJSXRuntime_namespaceObject.jsxs)(
            external_ReactJSXRuntime_namespaceObject.Fragment,
            {
    ...
    var format_strikethrough_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
    ...
    const underline_title = (0, external_wp_i18n_namespaceObject.__)(
        "Underline",
    );
    const underline = {
        name: underline_name,
    ...
    var text_color_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
    ...
    function getActiveColors(value, name, colorSettings) {
        ...
        return {
            ...
            ...parseClassName(
                activeColorFormat.attributes.class,
                colorSettings,
            ),
        };
    }
    ...
    var subscript_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
    ...
    const subscript_title = (0, external_wp_i18n_namespaceObject.__)(
        "Subscript",
    );
    const subscript = {
        name: subscript_name,
        ...
        edit({ isActive, value, onChange, onFocus }) {
            function onToggle() {
                onChange(
                    (0, external_wp_richText_namespaceObject.toggleFormat)(
                        value,
                        { type: subscript_name, title: subscript_title },
                    ),
                );
            }
            function onClick() {
    ...
    var superscript_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
        ...
        edit({ isActive, value, onChange, onFocus }) {
            function onToggle() {
                onChange(
                    (0, external_wp_richText_namespaceObject.toggleFormat)(
                        value,
                        { type: superscript_name, title: superscript_title },
                    ),
                );
            }
            function onClick() {
        ...
        edit({ isActive, value, onChange, onFocus }) {
            function onToggle() {
                onChange(
                    (0, external_wp_richText_namespaceObject.toggleFormat)(
                        value,
                        { type: keyboard_name, title: keyboard_title },
                    ),
                );
            }
            function onClick() {
    ...
    var language_default = /* @__PURE__ */ (0,
    external_ReactJSXRuntime_namespaceObject.jsx)(
        external_wp_primitives_namespaceObject.SVG,
        {
            xmlns: "http://www.w3.org/2000/svg",
                                        ...
                                        external_ReactJSXRuntime_namespaceObject.Fragment,
                                        {
                                            children: [
                                                ...
                                                external_ReactJSXRuntime_namespaceObject.jsx)(
                                                    ...
                                                    {
                                                        children:
                                                            ".wp-block-math__error .components-badge__content{white-space:normal}",
                                                    },
                                                ),
                                            ],
                                        },
    ...
    function math_Edit({
        ...
        const [latexToMathML, setLatexToMathML] = (0,
        external_wp_element_namespaceObject.useState)();
        (0, external_wp_element_namespaceObject.useEffect)(() => {
            Promise.resolve(/* import() */)
                .then(__webpack_require__.t.bind(__webpack_require__, 3533, 23))
                .then((module) => {
    ...
    const nonBreakingSpace = {
        ...
        edit({ value, onChange }) {
            function addNonBreakingSpace() {
                onChange(
                    (0, external_wp_richText_namespaceObject.insert)(
                        value,
                        "\xA0",
                    ),
                );
    ...
    default_formats_default.forEach(({ name, ...settings }) =>
